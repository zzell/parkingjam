...
export default function Game() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, padding: '12px 16px 8px', height: '100dvh', overflow: 'hidden', background: '#050510', color: '#fff', boxSizing: 'border-box' }}>
